...
## Подключение к локальному PG_ADMIN
Админка находится в докер-контейнере, который виден на http://localhost:5050. Для авторизации используем пару "admin@admin.de - password".
